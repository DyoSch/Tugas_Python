...
# Class Buku dengan initializer dan method read dan __str__
class Buku:
...
# Mendefinisikan skema data Buku
...
# Post: untuk menambah row baru ke dalam tabel buku
...
# Get: untuk membaca nilai dari tabel buku berdasarkan ID
